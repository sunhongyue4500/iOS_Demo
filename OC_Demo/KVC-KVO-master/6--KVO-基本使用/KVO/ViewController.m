...
- (void)viewDidLoad {
    ...
    [_stu addObserver:self forKeyPath:@"grade" options:NSKeyValueObservingOptionNew | NSKeyValueObservingOptionOld context:nil];
                       ...
                       context:(void *)context
{
    ...
    if ([object isKindOfClass:[Student class]] && [keyPath isEqualToString:@"grade"]) {
        
        NSLog(@"%@, old:%ld, new:%ld", @"stu", [change[NSKeyValueChangeOldKey] integerValue], [change[NSKeyValueChangeNewKey] integerValue]);
    }
...
- (void)dealloc
{
    ...
    [self.stu removeObserver:self forKeyPath:@"grade"];
}
